...
class SlowMotionEffect {
	...
	private:
		...
		static void spline_interpolate_block(Video& video_input, uint starting_frame, uint ending_frame, frame_spline_polynomials_t& pixel_polynomials);
		static void create_spline_polynomial(vector<pixel_t>& x0, vector<pixel_t>& y0, pixel_polynomial_t& pol_interpolate);
};
