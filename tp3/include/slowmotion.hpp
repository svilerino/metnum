...
class SlowMotionEffect {
	...
	private:
		...
		static void process_spline_block(const Video& video_input, Video& video_output, const uint starting_frame, const uint ending_frame, uint interpol_frame_count);
