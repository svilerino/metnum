...
\title{Reconstrucci\'on de Videos y Filtro de C\'amara Lenta mediante
...
\author{%
    ...
    Juan~Grandoso~\IEEEmembership{(juan.grandoso@gmail.com)} \and
    y Nahuel~Lascano~\IEEEmembership{(laski.nahuel@gmail.com)}
}
...
% you desire.
\markboth{Trabajo Pr\'actico 3, M\'etodos N\'umericos, Departamento de Computaci\'on, FCEN,
...
\IEEEtitleabstractindextext{%
    ...
    \begin{IEEEkeywords}
        Interpolación, Splines, Slowmotion, Procesamiento de video
    \end{IEEEkeywords}
...
\section{Implementaci\'on}
    \input{implementacion}\label{sec:implementacion}
    \FloatBarrier
