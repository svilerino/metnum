...
\begin{LaTeXdescription}
    ...
    \item[Proposici\'on] Nos interesa analizar cu\'an ''justo'' es GeM para
        ...
        ''justo'' en este caso y en este aspecto. Pero intu\'imos que esto no
        ser\'a lo que ocurra con GeM, ya que en el grafo de la instancia, A
        tiene un \'unicp eje saliente (hacia B) y 18 entrantes, con lo cual su
        arista deber\'ia hacer subir mucho a B en el ranking.\\
